...
export default function About() {
  return (
    <Styles>
      ...
      <p>
        Pick a base color, tweak it until just right, explore harmonies, and copy the CSS
        values for use in your projects.{' '}
      </p>
      <p>
        Please{' '}
        ...
        &mdash; let me know if this tool is useful for you, or if you find any bugs. I'd
        like to add additional functionality in the future. What features would you like
        to see?
      </p>
      <h3>How to</h3>
      <ul>
      ...
      <h3>Harmonies</h3>
      <p>
        Explore color combinations by toggling one of the six harmonies via these symbols.
        Each harmony has its own mood. Use harmonies to brainstorm color combos that work
        well together.
      </p>
      <Harmony>
        <div className="icon">
      ...
      <Harmony>
        ...
        <div className="desc">
          <h4>Analogous</h4>
          <p>
            Three colors of the same luminance and saturation with hues that are adjacent
            on the color wheel, 30 degrees apart. Smooth transitions.
          </p>
        </div>
      </Harmony>
      <Harmony>
